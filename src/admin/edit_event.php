    ...
    <main class="bg-gray-100 h-screen">
        <div class="w-full mx-auto py-10 px-5">
            ...
            <form class="flex flex-col" action="../update.php" method="POST">
                <input type="text" name="name" placeholder="イベント名" class="w-full p-4 text-sm mb-3" required value="<?= $event['id'] ;?>">
                ...
                <input name="end_at" placeholder="<?php echo date('Y-m-d H:i:s'); ?>" class="w-full p-4 text-sm mb-3" type="datetime-local"  required alue="<?= $event['end_at'] ;?>">
